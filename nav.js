...
(function() {
  ...
  let searchData = [
    ...
    {"id":"combat","title":"Combat Mechanics","url":"combat.html","description":"Combat systems and mechanics in depth","keywords":"combat fight battle damage mechanics hp health attack defense magic physical crit critical hit dodge block parry resist resistance endurance mana mana cost mana usage mana management mp status effects debuffs stun ministun root slow poison burn bleed damage over time dot armor break weaken attack reduction runic mark hp regeneration mana regeneration accuracy evasion hit chance miss chance damage formula damage calculation armor armor penetration armor effectiveness damage reduction resistance flat damage reduction endurance enchantment mana absorb mana leech lifesteal life steal reflect penetration pierce glancing blows glancing blow level scaling level disadvantage level difference damage penalty level gap enemy level higher level defensive stats"},
    ...
    {"id":"skills","title":"Skills","url":"skills.html","description":"Master powerful skills and devastating combos","keywords":"skills abilities powers talents combos active passive cooldown mana cost damage aoe single target buff debuff auto attack break armor charged strike clarity cleave execute final judgement heavy attack last stand normal attack poison attack quick attack rupture sacrifice shield static discharge stone skin vengeance witherstrike armorbreak shock"},
    ...
    {"id":"items-crafting","title":"Items & Crafting","url":"items-crafting.html","description":"Craft powerful equipment with voxel infusion","keywords":"items crafting equipment gear weapons armor voxel infusion blacksmith legendary epic rare common quality stats materials recipe affix affixes rarity mining pickaxe proficiency vein damage ore rock"},
